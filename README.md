...
## About You
1. Your name: Erica Hayes, Villanova University and Mia Partlow, NCSU Libraries
...
4. Proposed Lesson Title: Georeferencing and Displaying Historic Maps with Map Warper and ArcGIS Online

5. Lesson Abstract (3-4 sentences):
Georeferenced maps provide an opportunity to contextualize historic data. When published in a web environment, users can interact with historic maps in new ways. This lesson will teach you how to georeference a historic map using Map Warper, and will take you through the steps for visualizing and displaying your georeferenced map in a web browser environment like ArcGIS Online.

6. Case Study Description: None

7. Learning Outcomes (between 2-3)

  A. Users will learn how to georeference a historical map.

  B. Users will learn how to bring their georeferenced map into the online mapping platform, ArcGIS Online
  
  C. Users will learn best practices for georeferencing and applying control points to a digitized historical map.

8. Research Phase most relevant to your lesson (delete as appropriate):
Transform / Analyze / Present

9. Research Area most relevant to your lesson (delete as appropriate)
mapping

10. Intended Submission Date: May 2020

11. Lesson will use open technology and data at no cost to the reader:
Yes


12. Any other comments for the editor: We have successfully taught this lesson plan as a workshop at the NCSU Libraries and at Villanova University and we intend to adapt the activity for The Programming Historian.

Here is our submission on our GitHub README.md: [Georeferencing Tutorial](https://github.com/ericayhayes/georeferencingtutorial)

The markdown version for The Programming Historian submission is here: [georeferenceMaps.md](https://github.com/ericayhayes/georeferencingtutorial/blob/master/georeferenceMaps.md)
...
**Fig. 4: Select Control Points in the Control panel**
...
![](images/mapwarper_controlpoints_rmserrordelete.png)
**Fig. 5: Deleting control points and the RMS error**
...
**Fig. 6: Click Warp Image! to rectify your map**
...
**Fig. 7: "Georeferenced map in OpenStreetMap**
...
**Fig. 11: ArcGIS Online Add Layer**
...
**Fig 12: ArcGIS Online Tile Layer**
...
**Fig 15: ArcGIS Online georeferenced map view**
...
**Fig 16: ArcGIS Online Setting the Transparency**
...
**Fig. 22: ArcGIS Online Web Application: Build a Story Map**
