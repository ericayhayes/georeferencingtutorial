...
{% include figure.html filename="images/mapwarperzoom.png" caption="Map Warper zoom in and out" %}
...
{% include figure.html filename="images/mapwarper_tools.png" caption="Use the tools on the Rectify screen to pan, zoom, and add control points to your map" %}

44. Once you feel comfortable moving around in the maps, select your first control point. Start from the historic map and choose a location--for example, a city--that will be relatively easy to find.
...
{% include figure.html filename="images/mapwarper_addcontrolpoint.png" caption="Click the Add Control Point button" %}
...
{% include figure.html filename="images/mapwarper_controlpoints_delete.png" caption="Deleting control points and the RMS error" %}
...
{% include figure.html filename="images/mapwarper_export.png" caption="Map Warper Export" %}
...
{% include figure.html filename="arcgis_createawebapp.png" caption="ArcGIS Online Create a Web App" %}
...
{% include figure.html filename="arcgis_buildastorymap.png" caption="ArcGIS Online Web Application: Build a Story Map" %}
